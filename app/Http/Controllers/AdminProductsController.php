<?php namespace App\Http\Controllers;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Sub Categorie Id","name"=>"sub_categorie_id","join"=>"subcategories,id"];
			...
			$this->form[] = ['label'=>'Sub Categoria','name'=>'sub_categorie_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'subcategories,id'];
