...
class AdminProducts1Controller extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		$this->col[] = ["label" => "Sub Categoria", "name" => "sub_categorie_id", "join" => "subcategories,name"];
		...
		$this->col[] = [
			...
			"callback" => function ($row) {
				return $row->is_active == 1 ? "ACTIVO" : "INACTIVO";
			}
		];
		...
		$this->form = [];
		$this->form[] = ['label' => 'Nombre', 'name' => 'name', 'type' => 'text', 'validation' => 'required|string|min:5|max:5000', 'width' => 'col-sm-10'];
		$this->form[] = ['label' => 'Precio', 'name' => 'price', 'type' => 'money', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10'];
		$this->form[] = ['label' => 'Descripcion', 'name' => 'description', 'type' => 'textarea', 'validation' => 'required|string|min:5|max:5000', 'width' => 'col-sm-10'];
		// $this->form[] = ['label'=>'Stock','name'=>'stock','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
		$this->form[] = ['label' => 'Sub Categoria', 'name' => 'sub_categorie_id', 'type' => 'select2', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10', 'datatable' => 'subcategories,name'];
		...
		$this->form[] = ['label' => 'Descuento', 'name' => 'discount', 'type' => 'money', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10'];
		// $this->form[] = ['label'=>'Estado','name'=>'status','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
		$this->form[] = ['label' => 'Estado', 'name' => 'is_active', 'type' => 'radio', 'dataenum' => '1|Activo;2|Inactivo', 'validation' => 'required'];
		...
		$this->table_row_color[] = ['condition' => "[is_active] == 1", "color" => "success"];
		$this->table_row_color[] = ['condition' => "[is_active] == 0", "color" => "danger"];
